...
function1 <- function(mark) {
  ...
  df <- df[, c("group_75", "group_50", "group_25", "group_0")]
...
function3 <- function(m, degree) {
  ...
  write.table(all.marks.matrix.overlap.reordered,
              paste0("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.9e.",
                     degree,
                     ".tsv"),
  ...
  # 14. make heatmap
  p <- pheatmap(as.matrix(all.marks.matrix.overlap.reordered*100)[c(1:7, 15:21), c(1:7, 15:21)],
...
# 6. make plots
# 6.1. 75% upregulation
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.9e.75.pdf")
print(function3(m = x, degree = "group_75"))
dev.off()


# 6.2. 50% upregulation
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.9e.50.pdf")
print(function3(m = x, degree = "group_50"))
dev.off()


# 6.3. 25% upregulation
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.9e.25.pdf")
print(function3(m = x, degree = "group_25"))
dev.off()


# 6.4. 0% upregulation
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.9e.0.pdf")
print(function3(m = x, degree = "group_0"))
dev.off()
