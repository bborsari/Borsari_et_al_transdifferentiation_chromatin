...
flat.genes.variable.for.one.mark <- 
  read.table("~/public_html/Borsari_et_al_transdifferentiation_chromatin/genes/flat.genes.expression/flat.genes.variable.for.one.mark.txt",
             h=F, sep="\t", stringsAsFactors = F)
...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1w.pdf",
    height = 4)
