...
my.function2 <- function(mark) {
  ...
  # 3. for each mark keep only the selected variable genes 
  tmp.list <- list()
  for ( i in 1:10 ){
...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K27ac.PCA.pdf",
    width=25, height=6)
print(my.function3(f3.method = "PCA", seriate.m = H3K27ac.seriate))
dev.off()
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K27ac.PCA_angle.pdf",
    width=25, height=6)
...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K9ac.PCA.pdf",
    width=25, height=6)
print(my.function3(f3.method = "PCA", seriate.m = H3K9ac.seriate))
dev.off()
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K9ac.PCA_angle.pdf",
    width=25, height=6)
...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H4K20me1.PCA.pdf",
    width=25, height=6)
print(my.function3(f3.method = "PCA", seriate.m = H4K20me1.seriate))
dev.off()

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H4K20me1.PCA_angle.pdf",
    width=25, height=6)
...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K4me1.PCA.pdf",
    width=25, height=6)
print(my.function3(f3.method = "PCA", seriate.m = H3K4me1.seriate))
dev.off()

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K4me1.PCA_angle.pdf",
    width=25, height=6)
...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K4me3.PCA.pdf",
    width=25, height=6)
print(my.function3(f3.method = "PCA", seriate.m = H3K4me3.seriate))
dev.off()

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K4me3.PCA_angle.pdf",
    width=25, height=6)
...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K4me2.PCA.pdf",
    width=25, height=6)
print(my.function3(f3.method = "PCA", seriate.m = H3K4me2.seriate))
dev.off()

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K4me2.PCA_angle.pdf",
    width=25, height=6)
...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K9me3.PCA.pdf",
    width=25, height=6)
print(my.function3(f3.method = "PCA", seriate.m = H3K9me3.seriate))
dev.off()

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K9me3.PCA_angle.pdf",
    width=25, height=6)
...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K36me3.PCA.pdf",
    width=25, height=6)
print(my.function3(f3.method = "PCA", seriate.m = H3K36me3.seriate))
dev.off()

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K36me3.PCA_angle.pdf",
    width=25, height=6)
...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K27me3.PCA.pdf",
    width=25, height=6)
print(my.function3(f3.method = "PCA", seriate.m = H3K27me3.seriate))
dev.off()

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1y.H3K27me3.PCA_angle.pdf",
    width=25, height=6)
