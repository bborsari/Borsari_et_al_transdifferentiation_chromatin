...
# col_fun = colorRamp2(c(-10, 1, 1.8, 2.5),
#                      c("#c0dbeb", "#d9e9f3", "#f4a582", "#ca0020"))

col_fun = colorRamp2(c(-10, 0.85, 2.17, 2.5),
                     c("#c0dbeb", "#d9e9f3", "#f4a582", "#ca0020"))
...
p.H3K4me3.upregulation.pc <- heatmap.TSS.pc(mark = "H3K4me3",
                                           class = "upregulation",
                                           group = "positively_correlated",
                                           my.title = "H3K4me3 - upreg. - pc")

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.3f.H3K4me3.upregulation.positively_correlated.pdf",
    width = 5,
    height = 5)
p.H3K4me3.upregulation.pc
dev.off()


# 2. downreg & positively_correlated
p.H3K4me3.downregulation.pc <- heatmap.TSS.pc(mark = "H3K4me3",
                                             class = "downregulation",
                                             group = "positively_correlated",
                                             my.title = "H3K4me3 - downreg. - pc")

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.3f.H3K4me3.downregulation.positively_correlated.pdf",
    width = 5,
    height = 5)
p.H3K4me3.downregulation.pc
dev.off()


# 3. upreg + downreg & stable
p.H3K4me3.stable <- heatmap.TSS.stable(mark = "H3K4me3",
                                      group = "stable",
                                      my.title = "H3K4me3 - stable")


pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.3f.H3K4me3.stable.pdf",
    width = 5,
    height = 5)
p.H3K4me3.stable
dev.off()
