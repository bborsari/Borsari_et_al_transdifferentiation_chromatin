...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.10f1.pdf",
    width = 12, height = 4)
ggplot() +
  geom_violin(data = w, 
...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.10f2.pdf",
    width = 12, height = 4)
ggplot() +
