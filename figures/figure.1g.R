...
my.function <- function(mark) {
  ...
  # 4. get transposed matrix for expression
  ...
  # 5. PCA with significantly variable
  ...
  df.pca.mark.sig$group <- "significant"
  ...
  # 6. PCA with genes significantly
...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1g.pdf",
    height=18, width=14)
plot_grid(main.lop[[1]], NULL, main.lop[[2]], 
          main.lop[[3]], NULL, main.lop[[4]],
          main.lop[[5]], NULL, main.lop[[6]], 
          main.lop[[7]], NULL, main.lop[[8]],
          main.lop[[9]], 
