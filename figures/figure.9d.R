...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.9d.50.pdf", width=8)
function1(m="X50_perc")
dev.off()


pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.9d.25.pdf", width=8)
function1(m="X25_perc")
dev.off()


pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.9d.0.pdf", width=8)
function1(m="X0_perc")
dev.off()