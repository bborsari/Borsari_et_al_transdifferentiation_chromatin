...
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.1u.pdf",
    width = 25, height = 6)
print(HT)
dev.off()
...
write.table(setdiff(rownames(expression.matrix), ns.genes), 
            file = "~/public_html/Borsari_et_al_transdifferentiation_chromatin/genes/flat.genes.expression/flat.genes.variable.for.one.mark.peaks.txt",
...
write.table(ns.genes, 
            file = "~/public_html/Borsari_et_al_transdifferentiation_chromatin/genes/flat.genes.expression/flat.genes.for.expression.and.mark.peaks.txt",
            row.names = F, col.names = F, quote = F)
