...
# col_fun = colorRamp2(c(-10, -0.74, 0.38, 2), # good
#                      c("#c0dbeb", "#d9e9f3", "#f4a582", "#ca0020"))


col_fun = colorRamp2(c(-10, -0.5, 0.14, 2), # good
                     c("#c0dbeb", "#d9e9f3", "#f4a582", "#ca0020"))
...
p.H3K4me2.upregulation.pc <- heatmap.TSS.pc(mark = "H3K4me2",
                                            class = "upregulation",
                                            group = "positively_correlated",
                                            my.title = "H3K4me2 - upreg. - pc")

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.3f.H3K4me2.upregulation.positively_correlated.pdf",
    width = 5,
    height = 5)
p.H3K4me2.upregulation.pc
dev.off()


# 2. downreg & positively_correlated
p.H3K4me2.downregulation.pc <- heatmap.TSS.pc(mark = "H3K4me2",
                                              class = "downregulation",
                                              group = "positively_correlated",
                                              my.title = "H3K4me2 - downreg. - pc")

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.3f.H3K4me2.downregulation.positively_correlated.pdf",
    width = 5,
    height = 5)
p.H3K4me2.downregulation.pc
dev.off()


# 3. upreg + downreg & stable
p.H3K4me2.stable <- heatmap.TSS.stable(mark = "H3K4me2",
                                       group = "stable",
                                       my.title = "H3K4me2 - stable")


pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.3f.H3K4me2.stable.pdf",
    width = 5,
    height = 5)
p.H3K4me2.stable
dev.off()
