...
function1 <- function(mark) {
  ...
  df.melt <- df.melt[df.melt$variable == "group_75" & 
  ...
  p <- ggplot(df.melt, aes(x = value, y=H000, fill=value)) +
...
# 6. make plot
pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.9w.pdf", 
    width=15, height=3.5)
