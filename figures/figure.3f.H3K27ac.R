...
col_fun = colorRamp2(c(-10, -2, 0.32, 2.5),
...
p.H3K27ac.upregulation.pc <- heatmap.TSS.pc(mark = "H3K27ac",
                                            class = "upregulation",
                                            group = "positively_correlated",
                                            my.title = "H3K27ac - upreg. - pc")

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.3f.H3K27ac.upregulation.positively_correlated.pdf",
    width = 5,
    height = 5)
p.H3K27ac.upregulation.pc
dev.off()


# 2. downreg & positively_correlated
p.H3K27ac.downregulation.pc <- heatmap.TSS.pc(mark = "H3K27ac",
                                              class = "downregulation",
                                              group = "positively_correlated",
                                              my.title = "H3K27ac - downreg. - pc")

pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.3f.H3K27ac.downregulation.positively_correlated.pdf",
    width = 5,
    height = 5)
p.H3K27ac.downregulation.pc
dev.off()


# 3. upreg + downreg & stable
p.H3K27ac.stable <- heatmap.TSS.stable(mark = "H3K27ac",
                                       group = "stable",
                                       my.title = "H3K27ac - stable")


pdf("~/public_html/Borsari_et_al_transdifferentiation_chromatin/single_figures/fig.3f.H3K27ac.stable.pdf",
    width = 5,
    height = 5)
p.H3K27ac.stable
dev.off()
